...
public class LocalCameraHandler : MonoBehaviour
{
    ...
    void Start()
    {
        /*float cameraRotationX = GameManager.Instance.cameraViewRotation.x;
        float cameraRotationY = GameManager.Instance.cameraViewRotation.y;*/
    }
    ...
    void LateUpdate()
    {
        ...
        cameraRotationX = Mathf.Clamp(cameraRotationX, -45, 45);
